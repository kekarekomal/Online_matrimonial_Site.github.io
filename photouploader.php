  ...
  <div class="container">
   <div class="breadcrumb1">
     <ul>
        ...
        <li class="current-page">Upload Photos</li>
     </ul>
   </div>
   <div class="services">
	   ...
	   <form action="" method="post" enctype="multipart/form-data">
	      ...
	      <label for="edit-name">Upload Your Photo( Maximum Upto 2 images, Use 300 x 250 dimensions) <span class="form-required" title="This field is required.">*</span></label>
