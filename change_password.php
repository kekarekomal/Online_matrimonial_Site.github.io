...
session_start();
$_SESSION["id"];
$conn = mysqli_connect("localhost", "root", "root", "matrimony") or die("Connection Error: " . mysqli_error($conn));
        ...
        <div style="width: 500px;">
            ...
            <table border="0" cellpadding="10" cellspacing="0"
                ...
                <tr class="tableheader">
                    <td colspan="2"><center><b>Change Password</b></td></center>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2"><center><input type="submit" name="submit"
                        value="Submit" class="btnSubmit"></td></center>
                </tr>
            </table>
        </div>
    </form>
