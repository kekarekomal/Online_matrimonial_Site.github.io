...
<div class="grid_3" style="background-image: url(https://vivitravels.com/site-media/siti/images/india-wedding-celebration.jpg?w=732&quality=60);background-repeat: no-repeat;background-size: cover;opacity: 0.9; text-shadow: 5s;color: rgba(255,255,0,0.9);">
  <div class="container">
   <div class="breadcrumb1">
     <ul>
        <a href="index.php"><i class="fa fa-home home_1"></i></a>
        <span class="divider">&nbsp;|&nbsp;</span>
        <li class="current-page" style="font-size: 30px"><b>Register<b></li>
     </ul>
   </div>
   <div class="services">
	     ...
	     <form action="" method="POST">
		    ...
		    <div class="form-group">
		      <label for="edit-name"><b>Email<b> <span class="form-required" title="This field is required.">*</span></label>
		      <input type="text" id="edit-name" name="email" value="" size="60" maxlength="60" class="form-text required">
		    </div>
		    <div class="age_select">
		      <label for="edit-pass"><b>Date Of Birth <b><span class="form-required" title="This field is required.">*</span></label>
		        <div class="age_grid">
            ...
            <div class="col-sm-4 form_box2">
              ...
              <div class="form-group form-group1">
                <label class="col-sm-2 control-lable" for="sex"><b>Sex : <b></label>
                <div class="col-sm-3">
                    <div class="radios">
