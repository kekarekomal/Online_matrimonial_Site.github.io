...
<div class="col-md-9 search_left">
  ...
  <div class="form_but1">
    ...
    <div class="col-sm-7 form_radios">
      <div class="select-block1">
         <input type="text" id="edit-name" name="District/City" size="60" maxlength="60" class="form-text"placeholder="Enter Your District/City">
      </div>
    </div>
    <div class="clearfix"> </div>
  </div>
  ...
  <div class="form_but1">
	...
	<div class="col-sm-7 form_radios">
      ...
      <div class="col-sm-5 input-group1">
        <input class="form-control has-dark-background" name="agemax" id="slider-name" placeholder="55" type="text" required=""/>
      </div>
      <div class="clearfix"> </div>
	</div>
  <br>
  ...
  <br>
	<div class="clearfix"> </div>
  <center><input type="submit" name="search" value="Search" class="hvr-shutter-out-horizontal"/></center>
  </div>
 </form>
